...
const SettingsForm: Component<SettingsFormProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} class="p-4">
      ...
      <fieldset>
        <legend class="mt-1 mb-1 bg-blue-50 w-full pt-1 pb-1">
          Camera Settings
        </legend>
        ...
        <div class="flex items-center mb-2">
          ...
          <div class="w-1/2">
            <input
              ...
              class="bg-gray-100 border-gray-200 border-1  appearance-none rounded w-full py-1 px-2 text-gray-700 leading-tight focus:bg-white"
            />
          </div>
        </div>
